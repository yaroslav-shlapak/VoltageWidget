...
public class Utility {
    ...
    public static String getSavedBatteryInfo(Context context) {
        SharedPreferences batteryInfoSharedPref = context.getSharedPreferences(context.getString(R.string.battery_info_shared_pref),
                Context.MODE_PRIVATE);
        return batteryInfoSharedPref.getString(context.getString(R.string.battery_info_shared_pref), defaultString);
    }
    ...
    public static void saveBatteryInfo(Context context, String batteryInfo) {
        ...
        editor.putString(context.getString(R.string.battery_info_shared_pref), batteryInfo);
        editor.apply();
    }
}
